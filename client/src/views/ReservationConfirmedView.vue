...
<template>
    <div class="flex flex-col items-center justify-center h-screen bg-gray-50">
        ...
        <div v-else class="flex flex-col items-center justify-center">
            <h1 class="text-4xl font-bold text-gray-800 inline-flex items-center">
                Reservation Completed
                <svg class="w-12 h-12 ml-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
            </h1>
            <h3 class="text-md font-base text-gray-800 mb-5">You can now close this page</h3>
            <div class="border px-4 pt-3 pb-4 rounded-lg w-128 bg-white shadow-md">
                <div class="flex flex-col">
                    ...
                    <div class="flex flex-row justify-between w-full mt-8">
                        <a type="button" href="" class="inline-flex py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700">
