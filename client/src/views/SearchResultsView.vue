...
<template>
    <div class="flex flex-col items-center justify-screen h-screen dark:bg-gray-900">
        <div class="inline-flex justify-center mb-4 p-4 w-full bg-white border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            <div class="w-fit">
                <SearchBar></SearchBar>
            </div>
        </div>
        <div class="flex flex-row justify-start w-full h-full px-72 gap-4">
            <div class="h-96 w-72 bg-yellow-100"></div>
            <div class="flex items-center h-full w-full bg-green-100">
                <div id="loading" v-if="loading" class="w-full flex flex-col inline-flex items-center">
