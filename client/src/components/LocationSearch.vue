    ...
    <div class="relative p-4 w-224 max-w-224 h-full md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form class="flex justify-between items-center p-0 rounded-t border-b dark:border-gray-600" onsubmit="return false;">
                ...
                <button type="button" @click="$emit('onSelected', {lat: 0, lon: 0})" class="mr-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-2 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
