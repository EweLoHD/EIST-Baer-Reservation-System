    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <div class="justify-self-start flex rounded-md w-full" role="group">
            ...
            <form class="flex items-center w-full" onsubmit="return false">   
                ...
                <!--Serach Button-->
                <button type="button" class="flex-none py-2 px-4 ml-4 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" @click="onSearch()">
                    Search
                </button>
            </form>
        </div>
