...
<template>
<div class="flex flex-row items-center justify-between h-40 bg-white rounded-lg border hover:bg-gray-100" @click="onCardClick()" style="cursor: pointer;">
    ...
    <div class="flex flex-col justify-between px-4 pt-2 pb-4 h-full w-full">
        <div>
            ...
            <Rating :rating="Math.floor(restaurant.rating)" class="mt-1"/>
